...
<%@include file="/Header.jsp" %>
    ...
    <% message.setSubject ( "Ordine effettuato !");

         message.setContent ("<h1>Ciao, controlla nella sezione i miei ordini nella tua area personale per"
         		+" informazioni inerenti all'ordine e la prenotazione</h1>",
                            "Text / html");
          Transport.send (message);
         String title = "";
         String res ="Grazie per aver acquistato sul magnifico T-Tyre! :))" ;
         String docType = "\n <DOCTYPE html!>";
         out.println (docType +
         "<Html>	\n" +
